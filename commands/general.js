 ...
 * @author : SamPandey001 <https://github.com/excelottah6>
 * @description : BLACK-MD,A Multi-functional whatsapp bot.
 * @version 0.0.6
 **/
...
*Deploy Your Own:*-
https://github.com/excelottah6/BLACK-MD`
        let buttonMessaged = {
...
if(!isCreator) return citel.reply(tlang().owner);
let str="*All available themes in BLACKMD*"
